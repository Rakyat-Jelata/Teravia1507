...
const percent=
Math.round((currentStep/TOTAL_STEP)*100);
...
`Step ${currentStep} dari ${TOTAL_STEP}`;
...
const firstError=
formStep.querySelector(".is-invalid");
...
event.target.matches("#modalCancel")
...
event.target.matches("#modalConfirm")
...
"Lengkapi seluruh data sebelum dipublikasikan.",
...
"Terjadi kesalahan saat mempublikasikan iklan.",
